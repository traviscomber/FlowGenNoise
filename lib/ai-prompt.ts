export const CULTURAL_DATASETS = {
  ...
  "new-years-celebrations": {
    ...
    scenarios: {
      "times-square-nyc": {
        description:
          "Godlevel Times Square New Year's Eve excellence featuring iconic ball drop with massive crowds, confetti explosions, neon billboards, freezing winter night atmosphere, midnight countdown energy, infinite celebration dimensional artistry through computational NYC festivity mastery.",
      },
      "sydney-harbour": {
        description:
          "Godlevel Sydney Harbour New Year excellence featuring spectacular fireworks over Opera House and Harbour Bridge, summer celebration atmosphere, first major city to celebrate, waterfront crowds, infinite Australian dimensional artistry through computational harbour celebration mastery.",
      },
      "rio-copacabana": {
        description:
          "Godlevel Rio Copacabana New Year excellence featuring white-clad beach crowds, massive fireworks over ocean, samba music, tropical summer celebration, Reveillon traditions, infinite Brazilian dimensional artistry through computational beach party mastery.",
      },
      "edinburgh-hogmanay": {
        description:
          "Godlevel Edinburgh Hogmanay New Year excellence featuring torchlight procession, Edinburgh Castle fireworks, Scottish traditions, winter celebration, street parties, bagpipes, infinite Scottish dimensional artistry through computational Celtic celebration mastery.",
      },
      "tokyo-shibuya": {
        description:
          "Godlevel Tokyo Shibuya New Year excellence featuring massive crossing crowds, neon lights, temple bells at midnight, hatsumode shrine visits, winter illuminations, infinite Japanese dimensional artistry through computational urban celebration mastery.",
      },
      "dubai-burj-khalifa": {
        description:
          "Godlevel Dubai Burj Khalifa New Year excellence featuring world's tallest building fireworks, LED light shows, desert night sky, luxury celebration atmosphere, record-breaking displays, infinite UAE dimensional artistry through computational skyscraper celebration mastery.",
      },
      "london-thames": {
        description:
          "Godlevel London Thames New Year excellence featuring Big Ben midnight chimes, London Eye fireworks, river celebrations, winter atmosphere, British traditions, infinite UK dimensional artistry through computational riverside celebration mastery.",
      },
      "paris-champs-elysees": {
        description:
          "Godlevel Paris Champs-Élysées New Year excellence featuring Arc de Triomphe illuminations, Eiffel Tower light shows, champagne toasts, elegant French celebration, winter romance, infinite Parisian dimensional artistry through computational boulevard celebration mastery.",
      },
      "berlin-brandenburg-gate": {
        description:
          "Godlevel Berlin Brandenburg Gate New Year excellence featuring massive open-air party, fireworks, techno music, winter celebration, reunification symbolism, infinite German dimensional artistry through computational gate celebration mastery.",
      },
      "bangkok-chao-phraya": {
        description:
          "Godlevel Bangkok Chao Phraya New Year excellence featuring river fireworks, temple celebrations, tropical night atmosphere, Iconsiam displays, Thai cultural elements, infinite Thai dimensional artistry through computational river celebration mastery.",
      },
      "chinese-new-year": {
        description:
          "Godlevel Chinese New Year excellence featuring red lanterns, dragon dances, lion dances, firecrackers, family reunions, zodiac animals, spring festival atmosphere, infinite Chinese dimensional artistry through computational lunar celebration mastery.",
      },
      "diwali-celebration": {
        description:
          "Godlevel Diwali New Year excellence featuring oil lamps, rangoli patterns, fireworks, family gatherings, Hindu traditions, festival of lights, autumn celebration, infinite Indian dimensional artistry through computational light festival mastery.",
      },
      "rosh-hashanah": {
        description:
          "Godlevel Rosh Hashanah excellence featuring shofar blowing, apples with honey, synagogue services, Jewish traditions, autumn celebration, reflection and renewal, infinite Jewish dimensional artistry through computational high holiday mastery.",
      },
      "nowruz-persian": {
        description:
          "Godlevel Nowruz Persian New Year excellence featuring haft-seen table, spring equinox celebration, fire jumping, family gatherings, ancient Zoroastrian traditions, infinite Persian dimensional artistry through computational spring celebration mastery.",
      },
      "songkran-thailand": {
        description:
          "Godlevel Songkran Thai New Year excellence featuring water festival, street water fights, temple visits, Buddha statue bathing, April celebration, tropical atmosphere, infinite Thai dimensional artistry through computational water festival mastery.",
      },
      "ethiopian-enkutatash": {
        description:
          "Godlevel Ethiopian Enkutatash New Year excellence featuring yellow daisies, traditional coffee ceremonies, church services, September celebration, spring season, infinite Ethiopian dimensional artistry through computational cultural celebration mastery.",
      },
      "islamic-hijri": {
        description:
          "Godlevel Islamic Hijri New Year excellence featuring mosque gatherings, prayer services, reflection on Prophet's migration, lunar calendar celebration, spiritual atmosphere, infinite Islamic dimensional artistry through computational religious celebration mastery.",
      },
      "hmong-new-year": {
        description:
          "Godlevel Hmong New Year excellence featuring traditional ball tossing, colorful costumes, cultural performances, harvest celebration, community gatherings, infinite Hmong dimensional artistry through computational ethnic celebration mastery.",
      },
      "balinese-nyepi": {
        description:
          "Godlevel Balinese Nyepi New Year excellence featuring day of silence, ogoh-ogoh parades, meditation, spiritual purification, Hindu Saka calendar, infinite Balinese dimensional artistry through computational silent celebration mastery.",
      },
      "korean-seollal": {
        description:
          "Godlevel Korean Seollal New Year excellence featuring hanbok traditional dress, ancestral rites, tteokguk rice cake soup, family gatherings, lunar calendar celebration, infinite Korean dimensional artistry through computational cultural celebration mastery.",
      },
    },
  },
