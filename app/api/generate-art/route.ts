...
export async function POST(request: NextRequest) {
  try {
    ...
    const datasetMathematics = {
      ...
      tribes: {
        visualDescription: `intricate tribal pattern mathematics with ${Math.floor(numSamples / 100)} interconnected community nodes forming complex social network topologies, each tribe represented by ${Math.floor(12 + (seed % 8))} geometric totems arranged in sacred mathematical formations, kinship relationship graphs creating branching genealogical trees with ${numSamples} ancestral connection points, territorial boundary tessellations following natural mathematical divisions, ceremonial circle arrangements based on astronomical alignments and golden ratio proportions, migration path vectors showing historical movement patterns across mathematical landscape coordinates, cultural symbol matrices with recursive pattern inheritance, trade route networks forming optimal path algorithms between tribal settlements, seasonal gathering formations creating temporal mathematical cycles, spiritual mandala geometries with concentric mathematical layers representing cosmic tribal consciousness`,
        safeDescription: `tribal pattern mathematics, social network topology, geometric totems, kinship graphs, ${numSamples} connection points, ceremonial circles, cultural symbols, mathematical precision, ancestral art`,
      },
      heads: {
        visualDescription: `surreal mosaic head compositions with ${Math.floor(numSamples / 50)} fragmented facial geometry pieces creating kaleidoscopic portrait tessellations, each head constructed from ${Math.floor(200 + (seed % 300))} mathematical polygon fragments arranged in impossible anatomical configurations, cranial topology following non-euclidean surface mathematics with ${numSamples} vertex points defining bizarre facial contours, multiple overlapping profile perspectives creating cubist mathematical decompositions, eye socket geometries forming infinite recursive depth illusions, neural network pattern overlays showing synaptic mathematical connections across fragmented consciousness, facial feature displacement vectors creating surreal mathematical distortions, mosaic tile arrangements following fibonacci spiral patterns radiating from central facial focal points, chromatic aberration effects splitting facial features into prismatic mathematical components, impossible head orientations defying euclidean spatial constraints, fractal hair patterns with self-similar mathematical scaling, geometric beard and mustache formations following parametric curve equations, surreal expression mathematics with emotional state vectors`,
        safeDescription: `mosaic head compositions, fragmented facial geometry, polygon tessellations, ${numSamples} vertex points, cubist decompositions, neural patterns, mathematical distortions, surreal portraits, geometric art`,
      },
    }
