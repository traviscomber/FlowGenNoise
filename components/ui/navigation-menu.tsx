...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[animate=in]:animate-in data-[animate=out]:animate-out data-[animate=in]:fade-in data-[animate=out]:fade-out data-[animate=in]:zoom-in-90 data-[animate=out]:zoom-out-90 data-[animate=in]:slide-in-from-top-[-10px] data-[animate=out]:slide-out-to-top-[-10px] md:absolute md:w-auto md:data-[animate=in]:slide-in-from-left-2 md:data-[animate=out]:slide-out-to-left-2",
      className,
    )}
    {...props}
  />
