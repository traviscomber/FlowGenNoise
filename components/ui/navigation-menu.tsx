...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[animate-in]:fade-in data-[animate-out]:fade-out data-[animate-in]:slide-in-from-top-[-10px] data-[animate-out]:slide-out-to-top-[-10px] data-[orientation=horizontal]:slide-in-from-top-2 data-[orientation=vertical]:slide-in-from-left-2 data-[orientation=horizontal]:data-[animate-in]:slide-in-from-top-1 data-[orientation=vertical]:data-[animate-in]:slide-in-from-left-1 md:absolute md:w-auto",
      className,
    )}
    {...props}
  />
