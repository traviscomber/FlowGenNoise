...
>(
  (
    ...
    const [internalIsCollapsed, setInternalIsCollapsed] = React.useState(isCollapsed ?? false)
      ...
      >
        <ResizablePanel
          ...
          className={cn(
            ...
            internalIsCollapsed && "min-w-[50px] transition-all duration-300 ease-in-out",
            className,
          )}
          {...props}
        >
...
const SidebarTitle = React.forwardRef<HTMLHeadingElement, React.ComponentProps<"h3">>(
  ({ className, ...props }, ref) => (
